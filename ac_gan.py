...
def test():
    ...
    images, labels = inputs(64)


    [
        source_logits_real, class_logits_real, source_logits_fake,
        class_logits_fake, generated_images
    ] = inference(images, labels, z)

    d_loss, g_loss = loss(labels, source_logits_real, class_logits_real,
                                 source_logits_fake, class_logits_fake,
                                 generated_images)

    # train the model
    train_d_op, train_g_op = train(d_loss, g_loss)
